...
- `main.py`, `app/controller.py`, `ui/control_panel.py`, `ui/image_view.py`, `core/grid_utils.py`, `core/params.py`, `core/detector.py`
- docs in `docs/*`
...
1. `python -m py_compile main.py app/controller.py app/__init__.py ui/control_panel.py ui/image_view.py core/detector.py core/params.py core/grid_utils.py`
